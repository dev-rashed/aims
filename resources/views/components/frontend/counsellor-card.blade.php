...
<div class="card shadow-sm rounded-10 border-0">
    <div class="card-body">
        <div class="d-flex">
            ...
            <img src="{{ uploadedFile($counsellor->image) }}" alt="{{ $counsellor->full_name }}" class="w-60 h-60 rounded-100">
            </div>
            <div class="flex-grow-1 ms-3">
                <p class="fw-bold fs-16 text-primary-600 mb-0">{{ $counsellor->full_name }}</p>
                <p class="fw-medium fs-16 text-gray-800 mb-0">{{ $counsellor->designation }}</p>
                <div class="d-flex align-items-center">
                    ...
                    @endfor
                    <span class="fw-bold mb-0 fs-16">4.5</span>
                </div>
                <p class="fw-medium fs-14 text-gray-600">
                    <span class="fw-bold text-gray-800">7</span>
                    courses
                </p>
            </div>
        </div>
