    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-xl-4">
        <div class="col">
            <div class="card radius-10 border-start border-0 border-3 border-info">
                <div class="card-body">
                    <a href="{{ route('staff.course.index') }}" class="d-block">
                        <div class="d-flex align-items-center">
                            <div>
                                <p class="mb-0 text-secondary">Total Courses</p>
                                <h4 class="my-1 text-info">{{ $data['cources'] }}</h4>
                            </div>
        ...
        <div class="col">
            <div class="card radius-10 border-start border-0 border-3 border-danger">
                <div class="card-body">
                    <a href="{{ route('staff.enroll.index') }}" class="d-block">
                        <div class="d-flex align-items-center">
                            <div>
                                <p class="mb-0 text-secondary">Total Enroll</p>
                                <h4 class="my-1 text-danger">{{ $data['enrolls'] }}</h4>
                            </div>
        ...
        <div class="col">
            <div class="card radius-10 border-start border-0 border-3 border-success">
                <div class="card-body">
                    <a href="{{ route('staff.therapist.index') }}" class="d-block">
                        <div class="d-flex align-items-center">
                            <div>
                                <p class="mb-0 text-secondary">Total Therapists</p>
                                <h4 class="my-1 text-success">{{ $data['therapists'] }}</h4>
                            </div>
        ...
        <div class="col">
            <div class="card radius-10 border-start border-0 border-3 border-warning">
                <div class="card-body">
                    <a href="{{ route('staff.event.index') }}" class="d-block">
                        <div class="d-flex align-items-center">
                            <div>
                                <p class="mb-0 text-secondary">Total Events</p>
                                <h4 class="my-1 text-warning">{{ $data['events'] }}</h4>
                            </div>
