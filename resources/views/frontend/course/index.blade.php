...
@section('content')
    ...
    <x-frontend.section class="education-section"
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-4 text-center text-md-end">
                ...
                <div class="mt-5">
                    <a href="#course-section" class="btn bg-primary-500 rounded-26 py-3 px-5 text-white">Show Courses</a>
                </div>
            </div>
        </div>
    </x-frontend.section>
    ...
    <x-frontend.section class="course-section" id="course-section">
        <div class="d-flex align-items-center justify-content-between">
            <div class="section-heading">
                @php
                    $heading = ($data['type'] == 'Advanced') ? 'AIMS '.$data['type'].' Courses' : $data['type'].' Courses';
                @endphp
    ...
    @if (sectionSetting('counsellor_section'))
    ...
    <x-frontend.section class="subscribe-section">
        <div class="row">
            <div class="col-md-10 mx-auto">
                <div class="d-flex bg-s-cover bg-p-bottom align-items-center justify-content-center rounded-41"
                    style="background-image: url('{{ asset('build/assets/frontend/images/subscriber-bg.png') }}');height:458px">
