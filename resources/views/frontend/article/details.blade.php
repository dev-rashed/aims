                ...
                <div class="card-body p-5">
                    <div class="row align-items-end">
                            ...
                            <div class="details-info">
                                <div class="d-flex align-items-center mb-3 mb-lg-0">
                                    <div class="flex-shrink-0">
                                        <img src="{{ asset('build/assets/frontend/images/pen.png') }}" alt="Writen By" />
                                    </div>
                                ...
                                <div class="d-flex align-items-center mb-3 mb-lg-0">
                                    <div class="flex-shrink-0">
                                        <img src="{{ asset('build/assets/frontend/images/globe.png') }}" alt="Posted" />
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                ...
                                @if ($article->read_time !== null)
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="{{ asset('build/assets/frontend/images/book.png') }}" alt="Read Time" />
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                        ...
                        <div class="col-lg-5 ms-lg-auto">
                            <img src="{{ uploadedFile($article->image) }}" class="details-image rounded-20" alt="{{ $article->counsellor?->full_name }}" srcset="{{ uploadedFile($article->image) }}">
                        </div>
                    </div>
                    <div class="row mt-5">
                        <div class="col-12">
                            ...
                            <div class="col-sm-6 col-xl-3">
                                <a href="{{ route('article.details', $article->slug) }}">
                                    <div class="card border-0 rounded-20 bg-gray-100 h-100">
                                        <img src="{{ uploadedFile($article->image) }}" alt="{{ $article->title }}" class="article-img" srcset="{{ uploadedFile($article->image) }}" />
                                        <div class="card-body px-4">
                                            <h5 class="fw-medium card-title text-primary-700">{{ $article->title }}</h5>
                                        </div>
                                    </div>
                                </a>
                            </div>
